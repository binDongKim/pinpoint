...
public class HeatMapServiceImpl implements HeatMapService {
    ...
    @Override
    public LimitedScanResult<List<SpanBo>> dragScatterData(String applicationName, DragArea dragArea, int limit) {
        Objects.requireNonNull(applicationName, "applicationName");
        Objects.requireNonNull(dragArea, "dragArea");


        LimitedScanResult<List<Dot>> scanResult = applicationTraceIndexDao.scanScatterData(applicationName, dragArea, limit);
